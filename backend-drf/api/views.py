...
class StockPredictionAPIView(APIView):
    def post(self,request):
        ...
        if serializer.is_valid():
            ...
            return Response({'status':'success', 'plot_img':plot_img,'plot_100_dma':plot_100_dma,'plot_200_dma':plot_200_dma,'plot_prediction':plot_prediction,'mse':mse,'rmse':rmse,'r2':r2})
